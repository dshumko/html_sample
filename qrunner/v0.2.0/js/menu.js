...
var tdc_item = {
    items : [
        ...
        },
        {
            ...
            "tc"    : tdc_dir + "tdc_test.js",
            "img"   : "res/images/tdc.png"
        },
    ]
};

var html5_dir = "./tc/html5/";
var html5_item = {
    items : [
        {
            "id"    : "",
...
function drow_coverflow_menu(menu) {
    ...
    for (var i = 0; i < menu.items.length; i++) {
        ...
        list_div_infos.innerHTML = item.description_title;
