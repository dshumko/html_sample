...
module("Extensions for presence and messaging services");
...
module("Extensions for voice telephony services");
...
module("Extensions for video telephony services");
...
test("moveAt()", function() {
    try {
        ok(deviceInfoCollection.moveAt(), "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("remove", function() {
    try {
        ok(deviceInfoCollection.remove(), "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
