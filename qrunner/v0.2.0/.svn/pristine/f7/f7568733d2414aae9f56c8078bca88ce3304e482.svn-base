...
test("state", function() {
    try {
        ok(recording.state !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("error", function() {
    try {
        ok(recording.error !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});}
...
test("isManual", function() {
    try {
        ok(recording.isManual !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("isWidescreen", function() {
    try {
        ok(recording.isWidescreen !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
