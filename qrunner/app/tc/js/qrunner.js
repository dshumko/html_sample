var QControl = (function () {
    ...
    QControl.prototype.attach = function () {
        ...
        if (0 == qtest.getTotalCaseCount() && 0 == qtest.getModules().length) {
...
///<reference path='../libs/qunit/1.14.0/qunit-1.14.0.d.ts'/>
/**
*		QCase
*/
...
var QBridge = (function () {
    ...
    QBridge.prototype.start = function (index) {
        ...
        /* Begin of QUnit initialization */
        this.__reset_qunit__();
        /* End of QUnit initialization */
    ...
    QBridge.prototype.onReady = function (listener /*or QEventListener*/) {
        this.m_ready_listener = listener;
    };
    QBridge.prototype.onStart = function (listener /*or QEventListener*/) {
        this.m_started_listener = listener;
    };
    QBridge.prototype.onEnd = function (listener /*or QEventListener*/) {
        this.m_end_listener = listener;
    };
    QBridge.prototype.onStarting = function (listener /*or QEventListener*/) {
        this.m_starting_listener = listener;
    };
    QBridge.prototype.onResult = function (listener /*or QEventListener*/) {
        this.m_result_listener = listener;
    };
    QBridge.prototype.onLog = function (listener /*or QEventListener*/) {
...
var QView = (function () {
    ...
    QView.prototype.draw = function () {
        /*
         ...
         div.innerHTML = "<div id='htest'></div>";
...
var QTable = (function (_super) {
    ...
    QTable.prototype.addItem = function (id, item, visible) {
        ...
        if (tables) {
            ...
            tr = document.createElement("tr"); // root tr
...
///<reference path='./qview.ts'/>
///<reference path='./qcontrol.ts'/>
var QRunner = (function () {
    ...
    QRunner.init = function () {
        ...
        try {
            ...
            //QRunner.view.header['loop'].onCheck = QRunner._loop;
