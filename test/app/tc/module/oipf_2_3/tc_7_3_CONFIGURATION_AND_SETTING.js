...
test("onIpAddressChange", function() {
    try {
        ok(config.onIpAddressChange !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("familyName", function() {
    try {
        ok(localSystem.familyName !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("tvStandardsSupported", function() {
    try {
        ok(localSystem.tvStandardsSupported !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("startupInformation", function() {
    try {
        ok((startupInformation = localSystem.startupInformation) !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("onStartupInfoChange", function() {
    try {
        ok(localSystem.onStartupInfoChange !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("hasDigestCredentials()", function() {
    try {
        ok(localSystem.hasDigestCredentials !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("current3DMode", function() {
    try {
        ok(outputs[0].current3DMode !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("on3DModeChange", function() {
    try {
        ok(outputs[0].on3DModeChange !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
test("lnbInfo", function() {
    try {
        ok((lnbInfo = tuners[0].lnbInfo) !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("frontEndPosition", function() {
    try {
        ok(tuners[0].frontEndPosition !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
...
module("LNBInfo");
test("lnbType", function() {
    try {
        ok(lnbInfo.lnbType !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("lnbLowFreq", function() {
    try {
        ok(lnbInfo.lnbLowFreq !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("lnbHighFreq", function() {
    try {
        ok(lnbInfo.lnbHighFreq !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("crossoverFrequency", function() {
    try {
        ok(lnbInfo.crossoverFrequency !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("lnbStartFrequency", function() {
    try {
        ok(lnbInfo.lnbStartFrequency !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("lnbStopFrequency", function() {
    try {
        ok(lnbInfo.lnbStopFrequency !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("orbitalPosition", function() {
    try {
        ok(lnbInfo.orbitalPosition !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});

module("StartupInformation");
test("urlSource", function() {
    try {
        ok(startupInformation.urlSource !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
test("url", function() {
    try {
        ok(startupInformation.url !== undefined, "is exists");
    } catch (e) {
        ok (false, "not exists");
    }
});
